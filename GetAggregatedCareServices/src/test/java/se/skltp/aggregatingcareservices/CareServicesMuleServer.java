package se.skltp.aggregatingcareservices;
...
public class CareServicesMuleServer {

    private static final Logger logger = LoggerFactory.getLogger(CareServicesMuleServer.class);
